...
AAFireAlarm::AAFireAlarm()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_MainBody(TEXT("/Game/VRContent/Modeling/09_FireAlarm/SM_FireAlam_Body.SM_FireAlam_Body"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_Arm(TEXT("/Game/VRContent/Modeling/09_FireAlarm/SM_FireAlam_Arm.SM_FireAlam_Arm"));
