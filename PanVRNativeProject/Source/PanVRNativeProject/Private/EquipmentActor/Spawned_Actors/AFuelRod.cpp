...
AAFuelRod::AAFuelRod()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_FuelRodBody(TEXT("/Game/VRContent/Modeling/05_Cell(FuelRod)/SM_FuelRod_Stick.SM_FuelRod_Stick"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialFinder_FuelRodGauge(TEXT("/Game/VRContent/Material/SRS_STAGE_StickGauge.SRS_STAGE_StickGauge"));
