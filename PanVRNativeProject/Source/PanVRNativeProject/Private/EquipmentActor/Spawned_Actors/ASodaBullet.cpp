...
AASodaBullet::AASodaBullet()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_SodaBullet(TEXT("/Game/VRContent/Modeling/19_SodaGun/SM_SodaCan.SM_SodaCan"));
	if (ModelingFinder_SodaBullet.Succeeded())
	{
		ActorBaseMesh->SetStaticMesh(ModelingFinder_SodaBullet.Object);
	}
