#include "EquipmentActor/SodaGun_Actors/ASodaFreezer.h"
...
AASodaFreezer::AASodaFreezer()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_FreezerBody(TEXT("/Game/VRContent/Modeling/19_SodaGun/SM_SodaFreezerBody.SM_SodaFreezerBody"));
	if (ModelingFinder_FreezerBody.Succeeded())
	{
		ActorBaseMesh->SetStaticMesh(ModelingFinder_FreezerBody.Object);
	}
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_FreezerUpDoor(TEXT("/Game/VRContent/Modeling/19_SodaGun/SM_SodaFreezerUpDoor.SM_SodaFreezerUpDoor"));
	if (ModelingFinder_FreezerUpDoor.Succeeded())
	{
		UpwardFreezerDoorMesh->SetStaticMesh(ModelingFinder_FreezerUpDoor.Object);
	}
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_FreezerDownDoor(TEXT("/Game/VRContent/Modeling/19_SodaGun/SM_SodaFreezerDownDoor.SM_SodaFreezerDownDoor"));
	if (ModelingFinder_FreezerDownDoor.Succeeded())
	{
		DownwardFreezerDoorMesh->SetStaticMesh(ModelingFinder_FreezerDownDoor.Object);
	}
	...
	{
		ActorBaseMesh->SetMaterial(1, MatFinder_Main.Object);
		UpwardFreezerDoorMesh->SetMaterial(0, MatFinder_Main.Object);
		DownwardFreezerDoorMesh->SetMaterial(0, MatFinder_Main.Object);
	}
