...
AAToilet::AAToilet()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_MainBody(TEXT("/Game/VRContent/Modeling/18_23_Toilet/SM_ToiletMainBody.SM_ToiletMainBody"));
	if (ModelingFinder_MainBody.Succeeded() && ActorBaseMesh)
	{
		ActorBaseMesh->SetStaticMesh(ModelingFinder_MainBody.Object);
	}

	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_RubberDuck(TEXT("/Game/VRContent/Modeling/18_23_Toilet/SM_Rubberduck.SM_Rubberduck"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_Lever(TEXT("/Game/VRContent/Modeling/18_23_Toilet/SM_ToiletLever.SM_ToiletLever"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_Door(TEXT("/Game/VRContent/Modeling/18_23_Toilet/SM_ToiletDoor.SM_ToiletDoor"));
