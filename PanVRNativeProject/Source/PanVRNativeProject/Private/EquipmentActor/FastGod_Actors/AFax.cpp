...
AAFax::AAFax()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_FaxBody(TEXT("/Game/VRContent/Modeling/15_Printer_Fax_Stamp/SM_FAXBody.SM_FAXBody"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialFinder_Main(TEXT("/Game/VRContent/Material/SRS_Stage_PAX.SRS_Stage_PAX"));
