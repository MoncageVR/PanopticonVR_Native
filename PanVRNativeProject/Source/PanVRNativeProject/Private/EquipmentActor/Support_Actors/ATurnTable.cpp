#include "EquipmentActor/Support_Actors/ATurnTable.h"
...
AATurnTable::AATurnTable()
{
	...
	// Main Body Setting
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_MainBody(TEXT("/Game/VRContent/Modeling/26_TurnTable/SM_TurnTableBody.SM_TurnTableBody"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_HandleLever(TEXT("/Game/VRContent/Modeling/26_TurnTable/SM_TurnTableHandle.SM_TurnTableHandle"));
	...
	// Left Button Setting
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_LB(TEXT("/Game/VRContent/Modeling/26_TurnTable/SM_TurnTableLeftButton.SM_TurnTableLeftButton"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_RB(TEXT("/Game/VRContent/Modeling/26_TurnTable/SM_TurnTableRightButton.SM_TurnTableRightButton"));
