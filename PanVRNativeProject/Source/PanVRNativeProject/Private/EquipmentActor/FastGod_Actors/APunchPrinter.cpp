...
AAPunchPrinter::AAPunchPrinter()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_PPBody(TEXT("/Game/VRContent/Modeling/15_Printer_Fax_Stamp/SM_PP_Body.SM_PP_Body"));
	if (ActorBaseMesh && ModelingFinder_PPBody.Succeeded())
	{
		ActorBaseMesh->SetStaticMesh(ModelingFinder_PPBody.Object);
	}

	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_PPSandbag(TEXT("/Game/VRContent/Modeling/15_Printer_Fax_Stamp/SM_PP_Sandbag.SM_PP_Sandbag"));
