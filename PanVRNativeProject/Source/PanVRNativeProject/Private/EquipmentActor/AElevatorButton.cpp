...
AAElevatorButton::AAElevatorButton()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_EBMainBody(TEXT("/Game/VRContent/Modeling/08_ElevatorButton/SM_EB_MainBody.SM_EB_MainBody"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_EBButton1F(TEXT("/Game/VRContent/Modeling/08_ElevatorButton/SM_EB_Button_1.SM_EB_Button_1"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_EBButton2F(TEXT("/Game/VRContent/Modeling/08_ElevatorButton/SM_EB_Button_2.SM_EB_Button_2"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_EBButton3F(TEXT("/Game/VRContent/Modeling/08_ElevatorButton/SM_EB_Button_3.SM_EB_Button_3"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialFinder_Main(TEXT("/Game/VRContent/Material/SRS_Stage_ElevatorButton.SRS_Stage_ElevatorButton"));
...
void AAElevatorButton::Debug_TowerTo_1stFloor()
{
	for (TScriptInterface<IIEquipmentInitInterface> Equip : EquipmentWorldSubSystem->GetEquipmentArr())
	{
		...
		TowerBuildingRef = Cast<ATowerBuilding>(IEquipPtr);
		if (TowerBuildingRef)
			break;
		else
			continue;
