...
AASodaGun::AASodaGun()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_SodaGun(TEXT("/Game/VRContent/Modeling/19_SodaGun/SM_SodaGun.SM_SodaGun"));
	if (ModelingFinder_SodaGun.Succeeded())
	{
		ActorBaseMesh->SetStaticMesh(ModelingFinder_SodaGun.Object);
	}
