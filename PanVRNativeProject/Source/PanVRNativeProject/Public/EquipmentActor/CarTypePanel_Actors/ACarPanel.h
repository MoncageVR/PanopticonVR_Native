...
#pragma region CarKeyRelatedVariables
	...
	//
	UPROPERTY()
	TObjectPtr<UTimelineComponent> CarPanelTimeline;

	// 
	UPROPERTY()
	TObjectPtr<UCurveFloat> KeyHoleMoveCurve;
#pragma endregion

	UPROPERTY()
	TObjectPtr<class AACarCrane> LinkedCarCrane;
