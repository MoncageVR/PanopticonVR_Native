...
AAGameResultScreen::AAGameResultScreen()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SMFinder_Success(TEXT("/Game/VRContent/Modeling/LobbyRoom/GameResultPrinter/GameResultSuccess_SignalMesh.GameResultSuccess_SignalMesh"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SMFinder_Fail(TEXT("/Game/VRContent/Modeling/LobbyRoom/GameResultPrinter/GameResultFail_SignalMesh.GameResultFail_SignalMesh"));
