...
AALighter::AALighter()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_ZippoBody(TEXT("/Game/VRContent/Modeling/28_Lighter_Zippo/SM_Zippo_Body.SM_Zippo_Body"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ModelingFinder_ZippoHead(TEXT("/Game/VRContent/Modeling/28_Lighter_Zippo/SM_Zippo_Head.SM_Zippo_Head"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaFinder_Main(TEXT("/Game/VRContent/Material/SRS_STAGE_Main.SRS_STAGE_Main"));
	if (MaFinder_Main.Succeeded())
	{
		ActorBaseMesh->SetMaterial(0, MaFinder_Main.Object);
		LHead->SetMaterial(0, MaFinder_Main.Object);
	}
